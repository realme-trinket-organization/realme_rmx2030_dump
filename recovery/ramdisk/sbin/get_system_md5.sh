exclude="ck\\.fs|pl\\.fs|sysmd5\\.zip|sd_after|install-recovery\\.sh|install_recovery\\.sh|recovery-from-boot\\.p|recovery_rootcheck|vendor/nvdata|vendor/nvcfg|vendor/persist|vendor/protect"
if [ "$#" -eq 3 ];then
